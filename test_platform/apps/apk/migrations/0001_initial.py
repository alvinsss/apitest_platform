# Generated by Django 2.2.1 on 2019-07-08 16:09
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('upapkfile', models.FileField(upload_to='')),
                ('sum_status', models.IntegerField(default=0, verbose_name='运行状态')),
                ('sum_result', models.CharField(max_length=4, verbose_name='运行结果')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('apk_testtype', models.CharField(max_length=200, verbose_name='测试类型')),
                ('create_time', models.DateTimeField(auto_now_add=True, verbose_name='创建时间')),
                ('pkfile_path', models.FileField(upload_to='')),
                ('run_status', models.IntegerField(default=0, verbose_name='运行状态')),
                ('run_result', models.CharField(max_length=1000, verbose_name='运行结果')),
                ('del_status', models.IntegerField(default=0, verbose_name='是否删除')),
